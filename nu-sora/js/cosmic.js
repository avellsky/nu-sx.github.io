...
NS.dracoSection = function (st, go) {
  ...
  out.push(panel('Draco スマート望遠鏡　' + st.name, {
    ...
    el('p', { style:{ margin:'0 0 12px', color:'var(--ink2)' },
      text:'全天カメラは視野 95° で空全体を見張り、ガンダム望遠鏡は視野 0.42° で一点を深く見る。その間を埋めるのが Draco である。'
        + '望遠で約 1.7°、広角で 85.7° という二つの視野を同時に持ち、極軸合わせも別のガイド鏡も要らずに 300 秒露出まで追尾できる。'
        + '観測網が拾った事象に数十秒で向けられる「素早い中望遠」として、船橋局と郡山局に特注ハウジングとともに設置する。' }),
    el('div', { class:'grid g4' }, [
  ...
  out.push(panel('この望遠鏡の使いみち', { note:'全天カメラ（95°）→ Draco（1.7°）→ ガンダム望遠鏡（0.42°）の三段構え' },
