...
NS.dracoSection = function (st, go) {
  ...
  out.push(panel('Draco スマート望遠鏡　' + st.name, {
    ...
    el('p', { style:{ margin:'0 0 12px', color:'var(--ink2)' },
      text:'全天カメラは視野 95° で空全体を見張り、ガンダム望遠鏡は主鏡 600 mm の視野 0.29° で一点を深く見る。その間を埋めるのが Draco である。'
  ...
  out.push(panel('この望遠鏡の使いみち', { note:'全天カメラ（95°）→ Draco（1.7°）→ ガンダム望遠鏡 副鏡（1.08°）→ 主鏡（0.29°）と視野を絞っていく' },
