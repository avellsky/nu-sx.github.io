...
NS.V.about = function (root, go) {
  ...
  NS.add(root, el('div', { class:'grid g2' }, [
    panel('実データ（申請書に基づく）', { note:'このデモで正確に反映している内容' },
      el('ul', { style:{ margin:0, paddingLeft:'1.2em', fontSize:'12.5px', color:'var(--ink2)' } }, [
        ...
        'ガンダム望遠鏡（口径 600 mm F3.8 ／ 200 mm F3.0・船橋局）の諸元。視野は ZWO ASI174MM のセンサー実寸 11.25 × 7.903 mm と焦点距離（2,280 / 600 mm）から 2·atan(寸法/2f) で算出し、主鏡 0.283° × 0.199°・副鏡 1.074° × 0.755° となる。2018 年ふたご座流星群の月面衝突閃光 11 個の観測結果は、阿部新助・柳澤正久・小野寺圭祐「ふたご座流星群の月面衝突閃光から探る活動小惑星 Phaethon の cm サイズ粒子」日本惑星科学会誌 遊星人 33 (3), 262–269 (2024)',
  ...
  NS.add(root, el('div', { style:{ marginTop:'14px' } }, panel('参考文献 ― 流星・火球・スペースデブリ再突入',
    ...
    [cite('阿部新助・柳澤正久・小野寺圭祐', 2024, 'ふたご座流星群の月面衝突閃光から探る活動小惑星 Phaethon の cm サイズ粒子', '日本惑星科学会誌 遊星人, 33 (3), 262–269',
     ...
     '船橋局の「ガンダム望遠鏡」（口径 600 / 200 mm）による 2018 年ふたご座流星群の月面衝突閃光観測。約 3 時間で 11 個を検出し、メテオロイド質量 8–350 g・直径 1.7–5.9 cm・クレータ径 1–4 m を導いた。「リモート望遠鏡」画面の諸元と、船橋局の月面衝突閃光の解析はこの成果に基づく'],
