...
NS.SCOPES = [
  { id:'GDM-P', name:'ガンダム望遠鏡 主鏡', short:'主鏡 400', st:'FNB', ap:400, fl:1520, fr:3.8,
    fovX:0.42, fovY:0.27, res:0.8, cam:'ZWO ASI174MM-Cool', px:'1936 × 1216',
  ...
  { id:'GDM-S', name:'ガンダム望遠鏡 副鏡', short:'副鏡 200', st:'FNB', ap:200, fl:600, fr:3.0,
    fovX:1.08, fovY:0.68, res:2.0, cam:'ZWO ASI174MM-Cool', px:'1936 × 1216',
...
NS.V.telescope = function (root, go, arg) {
  ...
  /* --- 三段構えの説明 --- */
  NS.add(root, el('div', { style:{ marginTop:'14px' } }, panel('視野の三段構え', {
    note:'同じ事象を、広さの違う 3 つの視野で受け渡す' },
    [NS.table(['装置', '視野', '分解能', '役割', '設置'], [
      ...
      ['ガンダム望遠鏡 副鏡 200 mm', '1.08° × 0.68°', '2.0″', '広めの視野で目標を捕捉する', '船橋'],
      ['ガンダム望遠鏡 主鏡 400 mm', '0.42° × 0.27°', '0.8″', '月面衝突閃光・掩蔽など、深く細かく見る', '船橋']
    ], 'wide'),
