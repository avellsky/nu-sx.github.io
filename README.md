...
| 公開物 | パス | 内容 |
|---|---|---|
| **NU-SORA 観測ポータル デモ版** | [`nu-sora/`](nu-sora/) | 日本大学 全学屋上観測網「ソラ」（Nihon University Sky Observation and Resilience Array）の観測ポータル。全国 13 局の火球・スペースデブリ再突入・インフラサウンド・線状降水帯・気象／熱中症・夜空の明るさを統合表示する |
